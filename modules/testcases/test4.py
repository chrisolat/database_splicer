...
print("python3 ../generate_schema.py --generate_schema_tables --schemas contacts portal --outfile schema_tables.json")
os.system("python3 ../generate_schema.py --generate_schema_tables --schemas contacts portal --outfile schema_tables.json")
