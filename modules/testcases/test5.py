...
print("python3 ../generate_schema.py --generate_schema_tables --schemas brbytes portal --outfile schema_tables.json")
os.system("python3 ../generate_schema.py --generate_schema_tables --schemas brbytes portal --outfile schema_tables.json")

print("\npython3 ../generate_schema.py --generate_schema --infile schema_tables.json --outfile output.json")
os.system("python3 ../mgenerate_schema.py --generate_schema --infile schema_tables.json --outfile output.json ")
